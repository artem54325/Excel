...
namespace ExcelExample
{
    ...
    {
        public static string path = @"C:\Users\chilo\source\repos\ExcelExample\ExcelExample\files\v1.sav";
        //static void Main(string[] args)
        //{
        //    //using (FileStream fileStream = new FileStream(path, FileMode.Open, FileAccess.Read, FileShare.Read, 2048 * 10,
        //    //                                  FileOptions.SequentialScan))
        //    using(StreamReader fileStream = new StreamReader(path, Encoding.GetEncoding(1252)))
        //    {
        //        // Create the reader, this will read the file header
        //        SpssReader spssDataset = new SpssReader(fileStream.BaseStream);
